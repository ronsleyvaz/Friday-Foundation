...
Wait for their answer. Validate: the name should be lowercase, use hyphens not spaces, and not clash with an existing command name (voice-installer, decide, brief, meetingprep, weeklyreview, amplify, new-capability, explore-idea, scope-decision, learnings, shipping-retro, teach-team).
